...
import com.sincerly.fightcontentview.interfaces.ITrendChart;


public abstract class ATrendChart implements ITrendChart {
    private static final boolean DEBUG = false;
    private static final String TAG = "ATrendChart";
    ...
    protected int type1_1Color;
    protected int type1_2Color;
    protected int type1_3Color;
    protected int type1_4Color;
    ...
    public ATrendChart(Context context, LottoTrendView lottoTrendView) {
        ...
        this.type1_1Color = resources.getColor(R.color.type1_1Color);
        this.type1_2Color = resources.getColor(R.color.type1_2Color);
        this.type1_3Color = resources.getColor(R.color.type1_3Color);
        this.type1_4Color = resources.getColor(R.color.type1_4Color);
    ...
    public void initChart(Context context, int width, int height, float scale) {
        if (width != 0 && height != 0) {
...
//            drawLeftBottom();
    ...
    public void draw(Canvas canvas, int i, int i2, int i3, int i4, float f) {
        if (i3 > 0 && i4 > 0 && initOk()) {
            ...
            int width5= (int) (((float) this.mPicLeftTop.getWidth()) * f);
            int height5 = (int) (((float) this.mPicLeftTop.getHeight()) * f);
            canvas.save();
            this.mRect.set(width, height2, i3, i4 );
            ...
            this.mRect.set(0, 0, width5, height5);
    ...
    public void reCalcScroll(float f, int i, int i2) {
        if (this.mPicY != null && this.mPicXTop != null && this.mPicXBottom != null) {
            ...
            this.mCanScroll[1] = ((float) ((height2 ) + height)) * f > ((float) i2);
            this.mScrollRange[2] = (int) (((float) i2) - (((float) ((obj != null ? this.mTimeHeight : 0) + (height))) * f));
            this.mScrollRange[3] = (int) (((float) height2) * f);
            float f2 = (((float) i2) * 1.0f) / ((float) ((height2) + height));
